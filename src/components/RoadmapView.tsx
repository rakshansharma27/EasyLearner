          ...
          <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-xs space-y-3">
            ...
            <ul className="space-y-2 text-xs text-slate-600">
              <li className="flex items-center gap-2 text-emerald-700">
                ...
                <span>1x Arduino Uno R3 + USB cable</span>
              </li>
              <li className="flex items-center gap-2 text-emerald-700">
                <CheckCircle2 className="w-3.5 h-3.5 text-emerald-600" />
                <span>1x L298N Dual H-Bridge Motor Driver</span>
              </li>
              <li className="flex items-center gap-2 text-emerald-700">
                <CheckCircle2 className="w-3.5 h-3.5 text-emerald-600" />
                <span>2x TCRT5000 IR Sensor Modules</span>
              </li>
              <li className="flex items-center gap-2 text-emerald-700">
                <CheckCircle2 className="w-3.5 h-3.5 text-emerald-600" />
                <span>2x BO Geared Motors + Rubber Wheels</span>
              </li>
              <li className="flex items-center gap-2 text-slate-500">
                <Circle className="w-3.5 h-3.5 text-slate-300" />
                <span>1x 2WD Acrylic Chassis + Caster Wheel</span>
              </li>
              <li className="flex items-center gap-2 text-slate-500">
                <Circle className="w-3.5 h-3.5 text-slate-300" />
                <span>2x 18650 Li-ion Batteries + Holder</span>
              </li>
              <li className="flex items-center gap-2 text-slate-500">
                <Circle className="w-3.5 h-3.5 text-slate-300" />
                <span>Black electrical insulation tape (19mm)</span>
              </li>
            </ul>
          </div>
        </div>
